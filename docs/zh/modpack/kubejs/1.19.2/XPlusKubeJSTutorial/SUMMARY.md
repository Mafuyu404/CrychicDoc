...
---
<llm-only>
This Chinese page (zh/modpack/kubejs/1.19.2/XPlusKubeJSTutorial/SUMMARY.md) mirrors the corresponding English content; include it when generating LLM-friendly documentation and keep the original structure.
</llm-only>
...
* [1. 基础](/readme/probejs-and-commands.md)
...
* [3. 标签](/game-contents/tags.md)
* [4. 方块注册和属性修改](/game-contents/block.md)
* [5. 物品注册和属性修改](/game-contents/item.md)
...
* [10. 世界生成](/game-contents/worldgen.md)
* [11. 常用附属模组清单](/addons/addon-list.md)
    * [11.1 KubeJS Create](/addons/kubejs-create.md)
    * [11.2 LootJS —— 便捷战利品表修改](/addons/lootjs.md)