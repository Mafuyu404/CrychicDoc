...
---
<llm-only>
This Chinese page (zh/modpack/kubejs/1.19.2/XPlusKubeJSTutorial/game-contents/worldgen.md) mirrors the corresponding English content; include it when generating LLM-friendly documentation and keep the original structure.
</llm-only>
