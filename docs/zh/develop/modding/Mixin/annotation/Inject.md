...
---
<llm-only>
This Chinese page (zh/develop/modding/Mixin/annotation/Inject.md) mirrors the corresponding English content; include it when generating LLM-friendly documentation and keep the original structure.
</llm-only>
