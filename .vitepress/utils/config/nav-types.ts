...
export interface NavLink {
     ...
     * `prefixNavLinks` in `nav-link-access.ts` will prepend the active locale
...
export interface NavItem {
    ...
    dropdown?: {
         ...
         * - `"tabs"`      — category tabs on the left, content area on the right
         * - `"new-layout"` — reserved for future custom layouts
         */
        layout?: "columns" | "tabs" | "spotlight" | "new-layout";
...
/**
 * The root navigation configuration object assembled by `nav-config.ts`.
